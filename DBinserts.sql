INSERT INTO PERMISSION (permission_name) VALUES ("updateUser"), ("deleteUser"), ("createCongregationSchedule"), ("addavailability");
INSERT INTO USER_ROLE (role_name, role_description) VALUES ("admin", "admins are able to do anything"), ("bus driver", "bus drivers can do some things");
...
INSERT INTO USER_ACCOUNT_ROLE (role_ID, user_ID) VALUES (1, 1);
